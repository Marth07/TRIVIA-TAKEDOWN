...
peter = Fighter("Peter", 150, 500, 110, 18, "Lames", peter_img, 12)
steve = Fighter("Steve", 1100, 500, 130, 15, "Angles", steve_img, 10)
nyra = Fighter("Nyra", 150, 500, 160, 12, "Boucliers", nyra_img, 7)
brian = Fighter("Brian", 1100, 500, 90, 28, "Frappe", brian_img, 11)
